...
(julia -t2 --project scripts/BEG2007/PHASES_KOMA/4_core_koma.jl -- "SIMVER:ECOLI-CORE-BEG2007-PHASE_0") &
(julia -t2 --project scripts/BEG2007/PHASES_KOMA/5_koma_strip.jl -- "SIMVER:ECOLI-CORE-BEG2007-PHASE_0") &
...
(julia -t5 --project scripts/BEG2007/PHASES_KOMA/9_biomass_fba.jl -- "SIMVER:ECOLI-CORE-BEG2007-PHASE_3") &

...
let
    ...
    gene_map["Supp1"]["ACALD"] = ["adhE"]
    gene_map["Supp3"]["ACALD"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["ACALDt"] = [] # Not found
    gene_map["Supp3"]["ACALDt"] = []
    ...
    gene_map["Supp1"]["ACONTa"] = ["acnA"]
    gene_map["Supp3"]["ACONTa"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["ACONTb"] = ["acnB"]
    gene_map["Supp3"]["ACONTb"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["ACt2r"] = [] # Not find
    gene_map["Supp3"]["ACt2r"] = [] # Not find
    ...
    gene_map["Supp1"]["AKGDH"] = ["sucAB", "lpdA"]
    gene_map["Supp3"]["AKGDH"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["AKGt2r"] = [] # Not found
    gene_map["Supp3"]["AKGt2r"] = [] # Not found
    ...
    gene_map["Supp1"]["ALCD2x"] = [] # Not Found
    gene_map["Supp3"]["ALCD2x"] = [] # Not Found

    # [11] AMALT1::[Amylomaltase (maltotriose)] Alternate Carbon Metabolism
    # (-1.0) malt_c::[Maltose C12H22O11] ==> (2.0) glc__D_e::[D-Glucose]
    gene_map["Supp1"]["AMALT1"] = [] # Not Found
    gene_map["Supp3"]["AMALT1"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["ATPM"] = [] # Not apply
    gene_map["Supp3"]["ATPM"] = [] # Not apply
    ...
    gene_map["Supp1"]["ATPS4r"] = ["atpABCDEFGHI"]
    gene_map["Supp3"]["ATPS4r"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["BIOMASS_Ecoli_core_w_GAM"] = []
    gene_map["Supp3"]["BIOMASS_Ecoli_core_w_GAM"] = []

    # [15] CO2t::[CO2 transporter via diffusion] CO2 transporter via diffusion
    # (-1.0) co2_e::[CO2 CO2] <==> (1.0) co2_c::[CO2 CO2]
    gene_map["Supp1"]["CO2t"] = [] # Not apply
    gene_map["Supp3"]["CO2t"] = [] # Not apply
    ...
    gene_map["Supp1"]["CYTBD"] = ["cydABCD", "appBC", "cycBC"]
    gene_map["Supp3"]["CYTBD"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["D_LACt2"] = [] # Not found
    gene_map["Supp3"]["D_LACt2"] = [] # Not found
    ...
    gene_map["Supp1"]["ETOHt2r"] = [] # Not found
    gene_map["Supp3"]["ETOHt2r"] = [] # Not found

    # [21] EX_ac_e::[Acetate exchange] Acetate exchange
    # (-1.0) ac_e::[Acetate] <==> 
    gene_map["Supp1"]["EX_ac_e"] = [] # Not apply
    gene_map["Supp3"]["EX_ac_e"] = [] # Not apply

    # [22] EX_acald_e::[Acetaldehyde exchange] Acetaldehyde exchange
    # (-1.0) acald_e::[Acetaldehyde] ==> 
    gene_map["Supp1"]["EX_acald_e"] = [] # Not apply
    gene_map["Supp3"]["EX_acald_e"] = [] # Not apply

    # [23] EX_akg_e::[2-Oxoglutarate exchange] 2-Oxoglutarate exchange
    # (-1.0) akg_e::[2-Oxoglutarate] ==> 
    gene_map["Supp1"]["EX_akg_e"] = [] # Not apply
    gene_map["Supp3"]["EX_akg_e"] = [] # Not apply

    # [24] EX_co2_e::[CO2 exchange] CO2 exchange
    # (-1.0) co2_e::[CO2 CO2] <==> 
    gene_map["Supp1"]["EX_co2_e"] = [] # Not apply
    gene_map["Supp3"]["EX_co2_e"] = [] # Not apply

    # [25] EX_etoh_e::[Ethanol exchange] Ethanol exchange
    # (-1.0) etoh_e::[Ethanol] ==> 
    gene_map["Supp1"]["EX_etoh_e"] = []
    gene_map["Supp3"]["EX_etoh_e"] = []

    # [26] EX_for_e::[Formate exchange] Formate exchange
    # (-1.0) for_e::[Formate] ==> 
    gene_map["Supp1"]["EX_for_e"] = [] # Not apply
    gene_map["Supp3"]["EX_for_e"] = [] # Not apply

    # [27] EX_fru_e::[D-Fructose exchange] D-Fructose exchange
    # (-1.0) fru_e::[D-Fructose] ==> 
    gene_map["Supp1"]["EX_fru_e"] = [] # Not apply
    gene_map["Supp3"]["EX_fru_e"] = [] # Not apply

    # [28] EX_fum_e::[Fumarate exchange] Fumarate exchange
    # (-1.0) fum_e::[Fumarate] ==> 
    gene_map["Supp1"]["EX_fum_e"] = [] # Not apply
    gene_map["Supp3"]["EX_fum_e"] = [] # Not apply

    # [29] EX_gal_e::[D-Galactose exchange] Extracellular exchange
    # (-1.0) gal_e::[D-Galactose] <==> 
    gene_map["Supp1"]["EX_gal_e"] = [] # Not apply
    gene_map["Supp3"]["EX_gal_e"] = [] # Not apply

    # [30] EX_glc__D_e::[D-Glucose exchange] D-Glucose exchange
    # (-1.0) glc__D_e::[D-Glucose] <==> 
    gene_map["Supp1"]["EX_glc__D_e"] = [] # Not apply
    gene_map["Supp3"]["EX_glc__D_e"] = [] # Not apply

    # [31] EX_gln__L_e::[L-Glutamine exchange] L-Glutamine exchange
    # (-1.0) gln__L_e::[L-Glutamine] ==> 
    gene_map["Supp1"]["EX_gln__L_e"] = [] # Not apply
    gene_map["Supp3"]["EX_gln__L_e"] = [] # Not apply

    # [32] EX_glu__L_e::[L-Glutamate exchange] L-Glutamate exchange
    # (-1.0) glu__L_e::[L-Glutamate] ==> 
    gene_map["Supp1"]["EX_glu__L_e"] = [] # Not apply
    gene_map["Supp3"]["EX_glu__L_e"] = [] # Not apply

    # [33] EX_glyc_e::[Glycerol exchange] Extracellular exchange
    # (-1.0) glyc_e::[Glycerol] <==> 
    gene_map["Supp1"]["EX_glyc_e"] = [] # Not apply
    gene_map["Supp3"]["EX_glyc_e"] = [] # Not apply

    # [34] EX_h2o_e::[H2O exchange] H2O exchange
    # (-1.0) h2o_e::[H2O H2O] <==> 
    gene_map["Supp1"]["EX_h2o_e"] = [] # Not apply
    gene_map["Supp3"]["EX_h2o_e"] = [] # Not apply

    # [35] EX_h_e::[H+ exchange] H+ exchange
    # (-1.0) h_e::[H+] <==> 
    gene_map["Supp1"]["EX_h_e"] = [] # Not apply
    gene_map["Supp3"]["EX_h_e"] = [] # Not apply

    # [36] EX_lac__D_e::[D-lactate exchange] D-lactate exchange
    # (-1.0) lac__D_e::[D-Lactate] <==> 
    gene_map["Supp1"]["EX_lac__D_e"] = [] # Not apply
    gene_map["Supp3"]["EX_lac__D_e"] = [] # Not apply

    # [37] EX_mal__L_e::[L-Malate exchange] L-Malate exchange
    # (-1.0) mal__L_e::[L-Malate] ==> 
    gene_map["Supp1"]["EX_mal__L_e"] = [] # Not apply
    gene_map["Supp3"]["EX_mal__L_e"] = [] # Not apply

    # [38] EX_malt_e::[Maltose exchange] Extracellular exchange
    # (-1.0) malt_e::[Maltose C12H22O11] <==> 
    gene_map["Supp1"]["EX_malt_e"] = [] # Not apply
    gene_map["Supp3"]["EX_malt_e"] = [] # Not apply

    # [39] EX_nh4_e::[Ammonia exchange] Ammonia exchange
    # (-1.0) nh4_e::[Ammonium] <==> 
    gene_map["Supp1"]["EX_nh4_e"] = [] # Not apply
    gene_map["Supp3"]["EX_nh4_e"] = [] # Not apply

    # [40] EX_o2_e::[O2 exchange] O2 exchange
    # (-1.0) o2_e::[O2 O2] <==> 
    gene_map["Supp1"]["EX_o2_e"] = [] # Not apply
    gene_map["Supp3"]["EX_o2_e"] = [] # Not apply

    # [41] EX_pi_e::[Phosphate exchange] Phosphate exchange
    # (-1.0) pi_e::[Phosphate] <==> 
    gene_map["Supp1"]["EX_pi_e"] = [] # Not apply
    gene_map["Supp3"]["EX_pi_e"] = [] # Not apply

    # [42] EX_pyr_e::[Pyruvate exchange] Pyruvate exchange
    # (-1.0) pyr_e::[Pyruvate] ==> 
    gene_map["Supp1"]["EX_pyr_e"] = [] # Not apply
    gene_map["Supp3"]["EX_pyr_e"] = [] # Not apply

    # [43] EX_succ_e::[Succinate exchange] Succinate exchange
    # (-1.0) succ_e::[Succinate] ==> 
    gene_map["Supp1"]["EX_succ_e"] = [] # Not apply
    gene_map["Supp3"]["EX_succ_e"] = [] # Not apply
    ...
    gene_map["Supp1"]["FORt"] = [] # Not apply
    gene_map["Supp3"]["FORt"] = [] # Not apply
    ...
    gene_map["Supp1"]["FORt2"] = [] # Not found
    gene_map["Supp3"]["FORt2"] = [] # Not found
    ...
    gene_map["Supp1"]["FRUpts2"] = [] # Not found
    gene_map["Supp3"]["FRUpts2"] = [] # Not found

    # [50] FUM::[Fumarase] Fumarase
    # (-1.0) h2o_c::[H2O H2O] + (-1.0) fum_c::[Fumarate] <==> (1.0) mal__L_c::[L-Malate]
    gene_map["Supp1"]["FUM"] = ["fumA", "fumB", "fumC"]
    gene_map["Supp3"]["FUM"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["FUMt2_2"] = []
    gene_map["Supp3"]["FUMt2_2"] = []
    ...
    gene_map["Supp1"]["G3PD2"] = ["gpsA"]
    gene_map["Supp3"]["G3PD2"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["G6PDH2r"] = ["zwf"]
    gene_map["Supp3"]["G6PDH2r"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["GALKr"] = ["galK"]
    gene_map["Supp3"]["GALKr"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["GALabcpp"] = []
    gene_map["Supp3"]["GALabcpp"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["GAPD"] = ["gapA", "gapC1C2"]
    gene_map["Supp3"]["GAPD"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["GLCpts"] = []
    gene_map["Supp3"]["GLCpts"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["GLNabc"] = [] # Not found
    gene_map["Supp3"]["GLNabc"] = [] # Not found
    ...
    gene_map["Supp1"]["GLUSy"] = ["gltBD"]
    gene_map["Supp3"]["GLUSy"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["H2Ot"] = [] # Not apply
    gene_map["Supp3"]["H2Ot"] = [] # Not apply
    ...
    gene_map["Supp1"]["ICDHyr"] = ["icdA"]
    gene_map["Supp3"]["ICDHyr"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["LDH_D"] = ["dld"]
    gene_map["Supp3"]["LDH_D"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["MALTabcpp"] = []
    gene_map["Supp3"]["MALTabcpp"] = []
    ...
    gene_map["Supp1"]["MALt2_2"] = []
    gene_map["Supp3"]["MALt2_2"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["NADH16"] = ["nuoABEFGHIJKLMN"]
    gene_map["Supp3"]["NADH16"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["NADTRHD"] = ["pntAB"]
    gene_map["Supp3"]["NADTRHD"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["NH4t"] = [] # Not found
    gene_map["Supp3"]["NH4t"] = [] # Not found


    # [80] O2t::[O2 transport diffusion ] O2 transport  diffusion 
    # (-1.0) o2_e::[O2 O2] <==> (1.0) o2_c::[O2 O2]
    gene_map["Supp1"]["O2t"] = [] # Not apply
    gene_map["Supp3"]["O2t"] = [] # Not apply
    ...
    gene_map["Supp1"]["PFL"] = ["pflAB", "pflCD"]
    gene_map["Supp3"]["PFL"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["PIt2r"] = [] # Not found
    gene_map["Supp3"]["PIt2r"] = [] # Not found
    ...
    gene_map["Supp1"]["PYRt2"] = [] # Not found
    gene_map["Supp3"]["PYRt2"] = [] # Not found
    ...
    gene_map["Supp1"]["SUCCt2_2"] = [] # Not found
    gene_map["Supp3"]["SUCCt2_2"] = [] # Not found
    ...
    gene_map["Supp1"]["SUCCt3"] = [] # Not found
    gene_map["Supp3"]["SUCCt3"] = [] # Not found
    ...
    gene_map["Supp1"]["SUCDi"] = ["sdhABCD"]
    gene_map["Supp3"]["SUCDi"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["SUCOAS"] = ["sucCD"]
    gene_map["Supp3"]["SUCOAS"] = [
        Dict{String, Any}(
    ...
    gene_map["Supp1"]["UDPG4E"] = ["galE"]
    gene_map["Supp3"]["UDPG4E"] = [
        Dict{String, Any}(
